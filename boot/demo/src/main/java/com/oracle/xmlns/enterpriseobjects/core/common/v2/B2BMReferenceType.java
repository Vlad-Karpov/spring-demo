...
import com.oracle.xmlns.enterpriseobjects.core.custom.common.v2.CustomB2BMReferenceType;


/**
 * <p>Java class for B2BMReferenceType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="B2BMReferenceType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Custom" type="{http://xmlns.oracle.com/EnterpriseObjects/Core/Custom/Common/V2}CustomB2BMReferenceType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "B2BMReferenceType", propOrder = {
    "b2BMID",
    "collaborationID",
    "replyToMessageID",
    "b2BDocumentType",
...
public class B2BMReferenceType {
    ...
    protected CustomB2BMReferenceType custom;
    ...
    /**
     * 
     *                         Information about the B2B document type, standard and version being exchanged between the trading partners using the B2B gateway
     *                     
     * 
     * @return
     *     possible object is
     ...
     *                     Gets the value of the receiverTradingPartner property.
     * 
     * <p>
     ...
     * @return
     *     possible object is
     *     {@link CustomB2BMReferenceType }
     *     
     */
    public CustomB2BMReferenceType getCustom() {
        return custom;
    }
     ...
     *     
     */
    public void setCustom(CustomB2BMReferenceType value) {
        this.custom = value;
    }
